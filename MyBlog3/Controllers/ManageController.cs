    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Установлен поставщик двухфакторной аутентификации."
                : message == ManageMessageId.Error ? "Произошла ошибка."
                : message == ManageMessageId.AddPhoneSuccess ? "Ваш телефонный номер был добавлен."
                : message == ManageMessageId.RemovePhoneSuccess ? "Ваш телефонный номер был удален."
                : "";
